  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-white p-6 rounded-2xl border border-[#e2e7ff] shadow-ambient space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 text-xs">
          ...
          <div className="col-span-2 sm:col-span-3">
            <span className="text-[#727785] block font-medium">Full Address (Map Location)</span>
            <span className="font-semibold text-[#424754]">{data.fullAddress || 'N/A'}</span>
          </div>
          <div>
            <span className="text-[#727785] block font-medium">Latitude</span>
            <span className="font-bold text-[#0058be]">{data.latitude ? Number(data.latitude).toFixed(6) : '23.022500'}</span>
          </div>
          <div>
            <span className="text-[#727785] block font-medium">Longitude</span>
            <span className="font-bold text-[#0058be]">{data.longitude ? Number(data.longitude).toFixed(6) : '72.571400'}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl border border-[#e2e7ff] shadow-ambient space-y-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-xs">
          <div>
            <span className="text-[#727785] block font-medium">Seller Expected Price</span>
            <span className="font-black text-[#006947] text-base">
              {formatPriceCr(data.expectedPrice)}
            </span>
          </div>
          <div>
            <span className="text-[#727785] block font-medium">AI Suggested Price</span>
            <span className="font-black text-[#0058be] text-base">
              {data.aiSuggestedPrice ? formatPriceCr(data.aiSuggestedPrice) : 'N/A'}
            </span>
          </div>
          <div>
