        ...
        {isFlat ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <div>
              ...
              <input type="number" min="1" placeholder="e.g. 2800" {...register('carpetArea')} className="w-full px-4 py-3 rounded-xl border border-[#c2c6d6] text-sm outline-none focus:border-[#0058be] text-[#131b2e]" />
              {errors.carpetArea && <p className="text-xs text-[#ba1a1a] mt-1 font-medium">{errors.carpetArea.message}</p>}
            </div>

            <div>
              <label className="block text-xs font-bold text-[#424754] uppercase tracking-wider mb-1.5">Built-up Area (sq.ft)</label>
              <input type="number" min="1" placeholder="e.g. 3200" {...register('builtUpArea')} className="w-full px-4 py-3 rounded-xl border border-[#c2c6d6] text-sm outline-none text-[#131b2e]" />
            </div>
