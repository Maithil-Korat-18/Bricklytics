  ...
  return (
    <div className="space-y-8 animate-fadeIn">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-sm space-y-6">
        <div className="border-b border-slate-100 pb-4">
          <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
            <Building2 className="w-5 h-5 text-blue-600" /> 1. Property Information
          </h3>
          <p className="text-xs text-slate-500 mt-1">Basic title, property type, sale classification, and description</p>
        </div>
        ...
        <div className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              {...register('title')}
              className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-sm outline-none transition"
            />
            <p className="text-[11px] text-slate-400 mt-1">Provide a descriptive, attractive title for your listing (3-150 characters).</p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-sm outline-none bg-white font-medium"
              >
                <option value="Flat / Apartment">Flat / Apartment</option>
                <option value="Villa / House">Villa / House</option>
                <option value="Plot / Land">Plot / Land</option>
              </select>
              {errors.propertyType && <p className="text-xs text-red-500 mt-1 font-medium">{errors.propertyType.message}</p>}
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-6 pt-1">
                <label className="inline-flex items-center space-x-2.5 cursor-pointer">
                  ...
                  />
                  <span className="text-sm font-semibold text-slate-800">New Property</span>
                </label>
                ...
                <label className="inline-flex items-center space-x-2.5 cursor-pointer">
                  <input
                    ...
                    className="w-4 h-4 text-blue-600 border-slate-300 focus:ring-blue-500"
                  />
                  <span className="text-sm font-semibold text-slate-800">Resale Property</span>
                </label>
              </div>
              {errors.listingType && <p className="text-xs text-red-500 mt-1 font-medium">{errors.listingType.message}</p>}
            </div>
          </div>
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-sm space-y-6">
        <div className="border-b border-slate-100 pb-4">
          <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
            <MapPin className="w-5 h-5 text-emerald-600" /> 2. Location Details
          </h3>
          <p className="text-xs text-slate-500 mt-1">Specify state, city, area locality, and complete address</p>
        </div>
        ...
        <div className="space-y-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <select
                {...register('state')}
                className="w-full px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 text-slate-800 text-sm font-semibold outline-none focus:border-blue-500"
              >
          ...
          <div>
            ...
            {errors.locality && <p className="text-xs text-red-500 mt-1 font-medium">{errors.locality.message}</p>}
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-100 text-sm outline-none transition"
            />
            {errors.fullAddress && <p className="text-xs text-red-500 mt-1 font-medium">{errors.fullAddress.message}</p>}
          </div>
        </div>
      </div>
    </div>
