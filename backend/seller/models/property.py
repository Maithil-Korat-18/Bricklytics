...
class Property(SellerBaseDocument):
    ...
    confidence_score = me.FloatField(required=False, null=True)
    appreciation_annual_rate = me.FloatField(required=False, null=True)
    ...
    investment_reasons = me.ListField(me.StringField(), default=list)
    ...
    meta = {
        ...
        'indexes': [
            ...
            ('status', 'locality', 'bhk'),
            ('status', 'is_deleted', 'is_dataset_import'),
