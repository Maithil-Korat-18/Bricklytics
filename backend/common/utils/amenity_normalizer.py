"""
common/utils/amenity_normalizer.py — Centralized Amenity Normalization Layer
============================================================================
...
AMENITY_RULES = [
    # 1. Gym / Fitness
    ('Gym', re.compile(r'gym|fitness|health club|gymnasium', re.IGNORECASE)),
    
    # 2. Swimming Pool
    ('Swimming Pool', re.compile(r'pool|swimming', re.IGNORECASE)),

    # 3. EV Charging
    ('EV Charging', re.compile(r'ev|electric vehicle|charging', re.IGNORECASE)),
    ...
    # 8. Elevator
    ('Elevator', re.compile(r'elevator|lift|passenger lift', re.IGNORECASE)),
