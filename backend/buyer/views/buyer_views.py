...
class BuyerReplyView(BaseAPIView):
    permission_classes = [IsAuthenticated]
    ...
    def post(self, request, pk):
        ...
        res = self.service.add_buyer_message(str(request.user.id), pk, message_text)
        return self.success_response(data=res, message="Reply sent successfully.")
